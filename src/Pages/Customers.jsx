      ...
      <>
        <div className="min-h-screen  p-6 ">
          <div className="flex items-center mb-6">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-orange-700 
                         bg-orange-50 hover:bg-orange-100 rounded-md shadow-sm 
          ...
          <div className="bg-white rounded-lg shadow-lg">
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white p-6 rounded-t-lg shadow-sm">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {selectedCustomer.panCardImage && (
                            <button
                              ...
                              className="flex items-center text-orange-600 hover:text-orange-800 text-sm font-medium cursor-pointer"
                            >
                              <ExternalLink className="w-4 h-4 mr-1" />
                              View
                            </button>
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 px-4 sm:px-6 lg:px-8 py-6">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-8">
          {[
            { title: "Total Customers", value: totalCustomers, icon: UsersIcon, color: "orange" },
            { title: "KYC Verified", value: kycVerified, icon: IdCard, color: "teal" },
            { title: "Blocked Users", value: blockedUsers, icon: Lock, color: "red" },
            { title: "Active Users", value: activeUsers, icon: Unlock, color: "green" },
          ].map((stat, i) => {
            const colorMap = {
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {paginatedCustomers.map((customer) => (
                    <tr key={customer.uid} className="hover:bg-orange-50/40 transition-all">
