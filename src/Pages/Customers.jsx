...
const Customers = () => {
  ...
  const handleBlockCustomer = async (customerId) => {
    ...
    try {
      ...
      setSelectedCustomer((prev) =>
        prev && prev.uid === customerId ? { ...prev, isBlocked: prevStatus } : prev
      );
      customersList.forEach((c) => {
  ...
  const handleKYCAction = async (customerId) => {
    ...
    setSelectedCustomer((prev) =>
      prev && prev.uid === customerId ? { ...prev, isKYCVerified: newStatus } : prev
    );
    customersList.forEach((c) => {
    ...
    try {
      ...
      setSelectedCustomer((prev) =>
        prev && prev.uid === customerId ? { ...prev, isKYCVerified: prevStatus } : prev
      );
      customersList.forEach((c) => {
